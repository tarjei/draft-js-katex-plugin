...
var TeXBlock = function (_Component) {
  ...
  function TeXBlock(props) {
    ...
    _this.onMathInputChange = function (inputValue) {
      ...
      try {
        _this.props.katex.__parse(value); // eslint-disable-line no-underscore-dangle
      } catch (e) {
        invalid = true;
      } finally {
        _this.setState({
    ...
    _this.getValue = function () {
      var contentState = _this.props.store.getEditorState().getCurrentContent();
      var entityData = contentState.getEntity(_this.props.block.getEntityAt(0)).getData();
      return entityData;
    };
    ...
    value: function render() {
      ...
      if (this.state.editMode) {
        ...
        editPanel = _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'button',
              { className: buttonClass, disabled: this.state.invalidTeX, onClick: this.save },
              this.state.invalidTeX ? doneContent.invalid : doneContent.valid
            ),
            _react2.default.createElement(
              'button',
              { className: theme.removeButton, onClick: this.remove },
              removeContent
            )
          )
        );
      ...
      return _react2.default.createElement(
        ...
        this.state.editMode ? _react2.default.createElement(MathInput, {
          ...
          value: texContent
        }) : _react2.default.createElement(_KatexOutput2.default, { katex: katex, value: texContent, onClick: this.onClick, displayMode: displayMode }),
        editPanel
      );
    }
  }]);
