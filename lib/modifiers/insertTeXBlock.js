...
function insertTeXBlock(editorState, translator, tex) {
  ...
  var newContentState = contentState.createEntity('KateX', 'IMMUTABLE', {
    value: translator(texContent),
    inputValue: texContent,
    displayMode: displayMode
  });

  var newEditorState = _draftJs.AtomicBlockUtils.insertAtomicBlock(editorState, newContentState.getLastCreatedEntityKey(), ' ');
